...
namespace fastJSON
{
    ...
    public sealed class JSONParameters
    {
		...
		// <summary>
		/// Save property/field names as lowercamelcase (default = false)
		/// </summary>
		public bool SerializeToLowerCamelCaseNames = false;
                    ...
                    if (v != null)
                    {
						...
						switch (pi.Type)
                        {
                            ...
                            case myPropInfoType.String:
								if (v is int || v is Int32)
									oset = (int)v + "";
								else if (v is long || v is Int64)
									oset = (long)v + "";
								else
									oset = (string)v; 
								break;
                            case myPropInfoType.Bool: oset = (v.ToString() == "1" || v.ToString().ToLower() == "true" ? true : false); break;
...
//                            case myPropInfoType.Hashtable: // same case as Dictionary
        ...
        private DateTime CreateDateTime(string value)
        {
			...
			// datetime format = 2015-4-16 18:52:48. 0

			DateTime temp;
			DateTime.TryParseExact ("2015-4-16 18:52:48. 0", "yyyy-M-d hh:mm:ss. fff", null, DateTimeStyles.None, out temp);
			return temp;
//            int year;
//            int month;
//            int day;
